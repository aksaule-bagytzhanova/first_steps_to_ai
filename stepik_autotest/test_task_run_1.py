...
class TestMainPage():
    ...
    def test_guest_can_login(self, browser):
        print("test_guest_can_login")
        assert True

    # номер 2
    @pytest.mark.regression
    def test_guest_can_add_book_from_catalog_to_basket(self, browser):
        print("test_guest_can_add_book_from_catalog_to_basket")
        assert True
...
class TestBasket():
    ...
    def test_guest_can_go_to_payment_page(self, browser):
        print("test_guest_can_go_to_payment_page")
        assert True

    # номер 4
    @pytest.mark.smoke
    def test_guest_can_see_total_price(self, browser):
        print("test_guest_can_see_total_price")
        assert True
...
class TestBookPage():
    ...
    def test_guest_can_add_book_to_basket(self, browser):
        print("test_guest_can_add_book_to_basket")
        assert True

    # номер 6
    @pytest.mark.regression
    def test_guest_can_see_book_price(self, browser):
        print("test_guest_can_see_book_price")
        assert True
...
def test_guest_can_open_gadget_catalogue(browser):
    print("test_guest_can_open_gadget_catalogue")
    assert True